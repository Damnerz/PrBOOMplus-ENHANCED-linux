...
So you are in the Readme.md file for the Linux version of PrBOOMplus-ENHANCED ENHANCED.

So PrBOOMplus-ENHANCED gonna be a free software for a buch of Linux OS the basic UBUNTU and Fedora and maybe Arch and some other lightweight distros. But keep in mind, the originals wadfiles of DOOM are not provided. 
...
Doom on everything //// But Linux was the first to have the DoomGuy^^.
